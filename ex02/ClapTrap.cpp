...
ClapTrap::ClapTrap() : Name("ClapX"), Hit_Point(10) , Energy_Point(10) , Attack_damage(0)
{
...
void ClapTrap::attack(const std::string &target)
{
	...
	{
		std::cout << "ClapTrap " << GREEN << this->Name <<  RESET << " attacks "<<  RED << target << RESET << " , causing "  \
...
void ClapTrap::takeDamage(unsigned int amount)
{
	if (this->Energy_Point > 0 && this->Hit_Point > 0)
	{
		...
		std::cout << RED << "ClapTrap " << this->Name << " wasted or Insufficient energy points" << RESET << std::endl;
}
